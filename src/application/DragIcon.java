...
import javafxapplication2.EditorController;
import javafxapplication2.EditorModel;
...
public class DragIcon extends AnchorPane{
	...
	public void setType (DragIconType type) {
                ...
                EditorController ec = new EditorController(new EditorModel());
		...
		case blue:
			getStyleClass().add("icon-blue");
                        System.out.println("application.DragIcon.setType()");
		break;
